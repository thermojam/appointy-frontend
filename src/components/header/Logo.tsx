    ...
    return (
        <Link href="/" className="flex items-center text-foreground">
            <svg
                ...
                aria-hidden
            >
                <path d="M27.6686 24.8646C27.6686 24.8646 41.5009 35.3928 31.961 50.5415L15.8081 7.09267"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                ...
                <path d="M13.183 24.8717C13.183 24.8717 -0.638942 35.4135 8.91578 50.5528L25.0262 7.08818"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"/>
